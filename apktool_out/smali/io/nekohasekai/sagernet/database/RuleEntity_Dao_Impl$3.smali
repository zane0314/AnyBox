...
.method public createQuery()Ljava/lang/String;
    ...
    .line 1
    const-string v0, "UPDATE OR ABORT `rules` SET `id` = ?,`name` = ?,`config` = ?,`userOrder` = ?,`enabled` = ?,`domains` = ?,`ip` = ?,`port` = ?,`sourcePort` = ?,`network` = ?,`source` = ?,`protocol` = ?,`ruleset` = ?,`outbound` = ?,`packages` = ?,`prioritizeOverSmartRouting` = ? WHERE `id` = ?"
